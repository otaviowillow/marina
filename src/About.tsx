      ...
      <div className="about">
        ...
        <div className='content'>
          <main>
            ...
            <p>I am highly skilled in creating user flows, user journeys, architecture information, personas, wireframes, prototypes and style guides, I also have a brief experience working with Lighting Design System from Salesforce. My toolset includes Adobe XD, Figma, Adobe Photoshop, Adobe Illustrator, Adobe InDesign, Adobe Lightroom, Invision App, Marvel App, UXPIN, Axure RP, and proto.io.In my free time I love illustrating for fun (you can see some of them on my Dribbble account).</p>
          </main>
          <figure>
            <img src={imgMarina} />
          </figure>
